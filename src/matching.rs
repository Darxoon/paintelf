...
pub fn test_reserialize_directly(input_file_path: &Path, original: &[u8], deserialized: &ElfContainer) -> Result<()> {
...
pub fn test_reserialize_from_content(input_file_path: &Path, original: &ElfContainer, original_bytes: &[u8], deserialized: &FileData) -> Result<()> {
